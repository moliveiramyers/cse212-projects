...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Enqueu method was adding at the begining instead of end;
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: It did not have a case when _people.Turn was 0 or less, so it was never added to queu if that was the case.
    ...
    // Defect(s) Found: It is working after added a case when turn was 0 or less to add to queu again
